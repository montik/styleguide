...
var a = angular.module('sgApp', deps).value('duScrollOffset', 30).config(["$stateProvider", "$urlRouterProvider", "$locationProvider", "localStorageServiceProvider", "$ocLazyLoadProvider", function ($stateProvider, $urlRouterProvider, $locationProvider, localStorageServiceProvider, $ocLazyLoadProvider) {
...
angular.module('sgApp').controller('MainCtrl', ["$http", "$scope", "$location", "$state", "Styleguide", "Variables", "localStorageService", "Socket", function ($http, $scope, $location, $state, Styleguide, Variables, localStorageService, Socket) {
...
angular.module('sgApp').service('Styleguide', ["$http", "$rootScope", "Socket", "debounce", function ($http, $rootScope, Socket, debounce) {
